...
```bash
    git clone https://github.com/efabless/openlane.git --branch v1.0
    cd openlane/
...
```bash
    git clone https://github.com/efabless/openlane.git --branch v1.0
    docker pull efabless/openlane:v1.0
```

The generated IMAGE_NAME is efabless/openlane:v1.0
...
* **Note:**
    - Default PDK_ROOT is `$(pwd)/pdks`. If you have installed the PDK at a different location, run the following before `make mount`:
        ...
        ```
    - Default IMAGE_NAME is efabless/openlane:v1.0. If you want to use a different version, run the following before `make mount`:
        ```bash
